  ...
  loop: for (let i = 0; i < tokens.length; ) {
    ...
    switch (token) {
      ...
      case 'c': {
        ...
        segments.push([token, x1, y1, x2, y2, x, y]);
        break
      }
      ...
      case 'a': {
        ...
        segments.push([token, rx, ry, xRotation, largeArcFlag, sweepFlag, x, y]);
        break;
      }
