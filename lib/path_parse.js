  ...
  loop: for (let i = 0; i < tokens.length; ) {
    ...
    switch (token) {
      ...
      case 't': {
        ...
        segments.push({ type: token, values: [x, y]});
        break
      }
      ...
      case 'c': {
        ...
        segments.push({ type: token, values: [x1, y1, x2, y2, x, y]});
        break
      }
      ...
      case 'q': {
        ...
        segments.push({ type: token, values: [x1, y1, x, y]});
        break;
      }
      ...
      case 'h': {
        ...
        segments.push({ type: token, values: [x]});
        break;
      }
      case 'V':
      case 'v': {
        ...
        segments.push({ type: token, values: [y]});
        break;
      }
      ...
      case 'a': {
        ...
        segments.push({ type: token, values: [rx, ry, xRotation, largeArcFlag, sweepFlag, x, y]});
        break;
      }

      case 'Z':
      case 'z': {
        segments.push({ type: token, values: []});
        break;
      }
